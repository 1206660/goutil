...
type CacheTable struct {
	...
	// call keepalive when access
	callKeepAliveWhenAccess bool
}
...
// call keepalive when access by Damon
func (table *CacheTable) DisableKeepAliveWhenAccess() {
	table.Lock()
	defer table.Unlock()

	table.callKeepAliveWhenAccess = false
}
...
func (table *CacheTable) Value(key interface{}, args ...interface{}) (*CacheItem, error) {
	...
	if ok {
		...
		if table.callKeepAliveWhenAccess {
			r.KeepAlive()
		}
		return r, nil
	}
